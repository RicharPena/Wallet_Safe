...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-06-2025 a las 16:26:37
...
--
-- Volcado de datos para la tabla `asignacion_presupuesto`
--

INSERT INTO `asignacion_presupuesto` (`id`, `monto_asignado`, `perfil_asignado_id`, `rubro`, `perfil_id`) VALUES
(1, 150.00, 2, 'Transporte', 1),
(2, 300.00, 3, 'Alimentación', 1),
(3, 300.00, 2, 'Alimentación2', 1);
...
INSERT INTO `detalle_presupuesto` (`id`, `asignacion_id`, `perfil_id`, `rubro`, `monto`) VALUES
(1, NULL, 2, 'Café', 15.50),
(2, 1, 2, 'Transporte', 45.00),
(3, NULL, 3, 'Transporte escolar', 80.00),
(4, 2, 3, 'Desayunos', 50.00),
(5, NULL, 2, 'Transporte escolar2', 80.00);
...
INSERT INTO `gastos` (`id`, `monto`, `automatico`, `tipo`, `rubro`, `fecha`, `perfil_id`, `descripcion`, `detalle_id`) VALUES
(1, 20000.00, 1, 'Fijo', 'gg', '2025-06-11 21:34:28', 1, 'ez', NULL),
(2, 100.00, 0, 'Fijo', 'Salario', '2025-06-12 18:56:24', 2, 'Pago mensual', NULL),
(5, 10.00, 0, 'Fijo', 'Salario', '2025-06-12 22:49:52', 2, 'Pago mensual', 1),
(6, 10.00, 0, 'Fijo', 'Salario2', '2025-06-12 22:53:10', 2, 'Pago mensual2', NULL);
...
(3, 500.00, 0, 'Fijo', 'Salario', '2025-06-12 18:54:55', 2, 'Pago mensual'),
(4, 400.00, 0, 'Fijo', 'Salario', '2025-06-12 19:08:41', 1, 'Pago mensual');
