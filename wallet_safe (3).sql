...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-06-2025 a las 06:34:00
...
CREATE TABLE `asignacion_presupuesto` (
  ...
  `perfil_destino_id` int(11) DEFAULT NULL,
...
ALTER TABLE `asignacion_presupuesto`
  ADD PRIMARY KEY (`id`),
  ADD KEY `perfil_destino_id` (`perfil_destino_id`);
...
--
ALTER TABLE `asignacion_presupuesto`
  ADD CONSTRAINT `asignacion_presupuesto_ibfk_1` FOREIGN KEY (`perfil_destino_id`) REFERENCES `perfil` (`id`);
