...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-06-2025 a las 16:52:35
...
ALTER TABLE `asignacion_presupuesto`
  ADD PRIMARY KEY (`id`),
  ADD KEY `perfil_asignado_id` (`perfil_asignado_id`);
...
--
ALTER TABLE `asignacion_presupuesto`
  ADD CONSTRAINT `asignacion_presupuesto_ibfk_1` FOREIGN KEY (`perfil_asignado_id`) REFERENCES `perfil` (`id`);
